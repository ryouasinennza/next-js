...
type Story = ComponentStoryObj<typeof FlexLayout>
...
export const FlexShrink: StoryFn = () => {
  return (
    <>
...
export const FlexBasis: StoryFn = () => {
  return (
    <FlexLayout
      direction="column"
      maxWidth="600px"
